...
(0, ava_1.default)("parse calculation", async (t) => {
    var api = await swagger_parser_1.default.parse("./src/tests/generators/calculation/swagger.json");
    const content = await (0, generators_1.generate)(api, "baseUrl", undefined, true);
    t.snapshot(content);
});
(0, ava_1.default)("Angular parse calculation", async (t) => {
    var api = await swagger_parser_1.default.parse("./src/tests/generators/calculation/swagger.json");
