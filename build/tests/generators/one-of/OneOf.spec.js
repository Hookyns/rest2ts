...
(0, ava_1.default)("parse one of", async (t) => {
    var api = await swagger_parser_1.default.parse("./src/tests/generators/one-of/swagger.json");
    const content = await (0, generators_1.generate)(api, "", undefined, true);
    t.snapshot(content);
});
(0, ava_1.default)("Angular parse one of", async (t) => {
    var api = await swagger_parser_1.default.parse("./src/tests/generators/one-of/swagger.json");
